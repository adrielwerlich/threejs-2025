...
export function usePlayerInput() {
  ...
  return useMemo(() => ({
    ...controls,
    // You can also expose helper functions
    isMoving: controls.forward || controls.backward || controls.left || controls.right,
    isRunning: controls.run && (controls.forward || controls.backward || controls.left || controls.right),
  }), [
    controls.forward,
    controls.backward,
    controls.left,
